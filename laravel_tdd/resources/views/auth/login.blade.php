            ...
            <div class="item-header drop-shadow" style="margin-bottom: 160px;"> <!--style="margin-bottom: 150px;"-->
                    ...
                    <div class="emailpass">
                        ...
                        <div class="email emailpass-fz">
                            ...
                            <input id="email" type="email" class="forminput @error('email') is-invalid @enderror"
...
{{-- @dd($errors) --}}
                        ...
                        <div class="pass emailpass-fz">
                            ...
                            <input id="password" type="password" class="forminput @error('password') is-invalid @enderror"
                        ...
                        <div class="textbox">
                            <div class="formcheck">
                                <input class=" addformcheck" type="checkbox" name="remember" id="remember"
            ...
            <div class="item-footer drop-shadow">
                ...
                <div class="height">
                    ...
                    <img width="69" height="72"
                        src="https://mobi-iot.com/wp-content/uploads/2020/04/Biometrics_Full-color-1.svg">
